...
const ctaBtns: RegularBtnProps[] = [
    {id: 1, icon: LuHandshake, title: 'header.cta.contribute', variants: 'primary', url: 'https://api.whatsapp.com/send/?phone=201069418701&text&type=phone_number&app_absent=0'},
    {id: 2, icon: LuHeadset, title: 'header.cta.contactUs', variants: 'secondary', url: '/contact-us'},
];
...
export default function Main() {
    ...
    return <React.Fragment>
        ...
        <section className='relative w-full h-[100dvh] common-px pt-29 max-[1020px]:pt-23 pb-15 bg-lightColor shapedividers_com-6721'>
